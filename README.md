...
### 3.6 Placebo Test 可视化

下图展示了随机打乱情绪数据之后，Placebo Test 中情绪变量与未来收益之间的关系。
...
### 3.7 对 Placebo Test 的谨慎解释

尽管 Placebo Test 没有得到与原始回归类似的显著结果，但这并不能证明原始结果一定具有因果关系。

目前的 Placebo Test 只进行了单次随机打乱。
...
同时，随机打乱情绪数据后的 Placebo Test 未能复现原始数据中的显著日内关系。
